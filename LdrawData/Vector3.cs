...
namespace LdrawData
{
        ...
        : IComparable, IComparable<Vector3>, IEquatable<Vector3>, IFormattable
    {
        ...
        /// <Acknowledgement>This code is adapted from CSOpenGL - Lucas Vi�as Livschitz </Acknowledgement>
        ...
        /// </implementation>
        /// <Acknowledgement>This code was provided by MichaB BryBka</Acknowledgement>
        ...
        public static Vector3 Interpolate(Vector3 v1, Vector3 v2, double control, bool allowExtrapolation)
        {
            if (!allowExtrapolation && (control > 1 || control < 0))
            {
                ...
                throw new ArgumentOutOfRangeException
                        (
                            "control", control, INTERPOLATION_RANGE + "\n" + ARGUMENT_VALUE + control
                        );
            }
            else
            {
