...
public class KDTree
{
    ...
    static int FindSplitPoint(
        Vector3[]
         points, int[] inds, int stIndex, int enIndex, int axis)
    {
    ...
    void Search(
        Vector3
         pt, ref double bestSqSoFar, ref int bestIndex)
    {
        Vector3 v = pivot - pt;
        ...
        double planeDist = pt[axis] - pivot[axis]; //DistFromSplitPlane(pt, pivot, axis);
    ...
    void insert(Vector3 point, int level)
    {
